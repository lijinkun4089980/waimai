 ...
 *
 */
public class ItemOrder extends IdEntity {

	/** 订单主表ID **/ 
	private Integer tMainOrderId;
	/** 分类主表ID **/ 
	private Integer storeMainGoodsId;
	/** 商品ID **/ 
	private Integer tStoreItemGoodsId;
	/** 商品名称 **/ 
	...
	/** 有参构造函数 **/
	public ItemOrder(Integer tMainOrderId,Integer storeMainGoodsId,Integer tStoreItemGoodsId,String goodsName,String goodsPictureLocation,double goodsCost,double goodsPackingCost,String goodsSpecification,String remark,String creater,Date createTime,Integer createrId,String updater,Date updateTime,Integer updaterId){
		super();
		this.tMainOrderId = tMainOrderId;
		this.storeMainGoodsId = storeMainGoodsId;
		this.tStoreItemGoodsId = tStoreItemGoodsId;
	 ...
	 * @return 订单主表ID
	 */
	public Integer getTMainOrderId() {
		return tMainOrderId;
	}
	/**
	 * @param tMainOrderId 订单主表ID
	 */
	public void setTMainOrderId(Integer tMainOrderId) {
		this.tMainOrderId = tMainOrderId;
	}
	 ...
	 * @return 商品ID
	 */
	public Integer getTStoreItemGoodsId() {
		return tStoreItemGoodsId;
	}
	/**
	 * @param tStoreItemGoodsId 商品ID
	 */
	public void setTStoreItemGoodsId(Integer tStoreItemGoodsId) {
		this.tStoreItemGoodsId = tStoreItemGoodsId;
	}
